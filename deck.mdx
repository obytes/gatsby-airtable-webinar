...
<Head>
  ...
  <meta name="twitter:title" content="Building MVPs with Gatsby & Airtable quicker and cheaper" />
  <meta
    name="twitter:description"
    content="Building MVPs with Gatsby & Airtable quicker and cheaper"
  />
</Head>

<div style={{ textAlign: "left" }}>
  <h1>Building MVPs with Gatsby & Airtable quicker and cheaper</h1>
</div>
...
<ul style={{ textAlign: "left" }}>
  <Appear>
    ...
    <li>
      I work as a Front-end developer at <a style={{ color: "#fff" }}
        href="https://obytes.com/?ref=gatsby-airtable-webinar"
        target="_blank">Obytes</a> with an amazing team of talented
      people.
    </li>
    <li>
      ...
      <a
        style={{ color: "#fff" }}
        href="https://ai-hashtags.com/?ref=gatsby-airtable-webinar"
        target="_blank"
      >
        Ai Hashtags{" "}
      </a>
      & <a
        style={{ color: "#fff" }}
        href="https://beafapp.com/?ref=gatsby-airtable-webinar"
        target="_blank"
      >
        Beaf
      </a>
    ...
    <li>
      ...
      <a
        style={{ color: "#fff" }}
        href="https://smakosh.com/blog/?ref=gatsby-airtable-webinar"
        target="_blank"
      >
        smakosh.com/blog
      </a>
    ...
    <li>
      ...
      <a
        style={{ color: "#fff" }}
        href="https://unnamed.smakosh.com/?ref=gatsby-airtable-webinar"
        target="_blank"
      >
        Unnamed
      </a>{" "}
...
- Slides: https://gatsby-airtable-webinar.netlify.com/
- Gatsby app: https://github.com/obytes/gatsby-airtable-starter
- CRA app: https://github.com/obytes/CRA-Airtable
